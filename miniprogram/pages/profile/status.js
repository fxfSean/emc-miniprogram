Page({
  ...
  async onShow() {
    ...
    const views = {
      PENDING: { icon: '…', title: '资料审核中', copy: '管理员确认成员身份后即可预约设备', className: 'pending' },
      REJECTED: { icon: '!', title: '资料未通过审核', copy: user.reviewNote || '请核对资料后重新提交', className: 'rejected' },
      DISABLED: { icon: '停', title: '账号已被禁用', copy: '该账号暂时无法使用设备与预约功能，如有疑问请联系实验室管理员。', className: 'disabled' }
    }
